// ngElastic.directive('scrollTable', function() {
// 	return {
// 		restrict:'EA',
...
// 	}
// })
ngElastic.controller('tableController', function($scope, $http, $window, $anchorScroll, DTOptionsBuilder) {
	// angular.element(document.querySelector('#tab')).bind('wheel', function(e){
	// 	var windowElement = angular.element($window);
	// 	console.log(e.target.offsetTop);
	// 	// console.log(windowElement[0].target.scrollTop);
	// 	// console.log(windowElement[0].view.innerHeight);
	// 	// angular.element(document.querySelector('#tab1:not(this)')).windowElement.scrollTop();
	// 	console.log($("#tab1:not(this)"));
 //  });
 //  angular.element(document.querySelector('#tab1')).bind('wheel', function($window){
 //  	var windowElement = angular.element($window);
	// 	$("#tab:not(this)").scrollTop($(this).scrollTop());
 //  });
 	var vm = this;
  		...
  		_.map($scope.dataset, function(d) {
				$scope.$watch('limit', function(limit) {
					if($scope.limit == 'All' || limit==undefined || $scope.limit > d._source.heading.length){
						...
						$scope.heading = _.take(d._source.heading, 5);
					}});
					// thead (date)
					$scope.heading = _.take(d._source.heading, 5);
				// });
